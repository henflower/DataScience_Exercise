...
The role of GitHub is to centrally host different versions and branches and form the master version. For your own backup data should be stored in personal cloud storage, because GitHub admins can delete your fork.
```
...
ggplot(data = datase,aes(x = treatment, y = activity, color = species)) + 

...
#The original file and the modified section can be viewed at the same time, 
#with the committer and comments of the code marked. 
#Modified parts of the file are marked in green, and deleted parts are marked in red.
```
...
ggplot(data = datase,aes(x = treatment, y = sl)) + geom_boxplot() + facet_wrap(~species, nrow = 2)
ggplot(data = datase,aes(x = treatment, y = size)) + geom_count() + facet_wrap(~species, nrow = 2)
ggplot(data = datase,aes(x = treatment, y = activity)) + geom_boxplot() + facet_wrap(~species, nrow = 2)
...
t = readPNG("./pics/acantho.png")
fig1 <- ggplot(data = datase,aes(x = treatment, y = activity, color = species)) + 
   geom_boxplot() + annotation_raster(t,xmin = 2, xmax = -2, ymin = 2, ymax = 20)
ggsave("./.gitignore/output/figures/fig1.png",plot = fig1)
fig1
```
